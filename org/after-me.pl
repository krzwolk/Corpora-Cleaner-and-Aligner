...
Co to jest origami.
Kupiłem sobie czerwone buciki.
Większość ludzi sądzi, że wiem co to jest origami .
Tak totalnie popsuło.
Są to trzepoczące ptaki, zabawki, Piekło Niebo, te rzeczy.
Tym w przeszłości było origami.
Ale stało się czymś innym.
Stało się formą sztuki, formą rzeźby.
Wspólny motyw esencja origami to składanie, tak tworzy się formy.
Origami jest bardzo stare .
...
I tak mogło by być.
Ale w XX wieku pojawił się japoński mistrz zwany Yoshizawa i stworzył dziesiątki tysięcy nowych wzorów.
...
I w przypadku origami, doprowadziło do rzeczy takich, jak ta.
To jest forma origami jeden arkusz, bez nacinania, tylko składanie, setki zagięć.
...
Tajemnicą produktywności w wielu dziedzinach również w origami jest sprawienie, by nieżyjący ludzie odwalili robotę za ciebie.
...
Ta siatka tutaj to podstawowy schemat figury origami.
...
Pierwsza zasada to dwukolorowość .
Każdą siatkę da się zapełnić dwoma kolorami tak, że pola w tym samym kolorze się nie stykają.
Kierunek zginania wzdłuż każdej osi liczba wypukłych i wklęsłych zagięć zawsze różnią się o dwa .
Dwa więcej lub dwa mniej.
Nic poza tym.
...
To cztery proste zasady .
To wszystko, czego potrzeba w origami.
Całe origami na tym się opiera.
Zastanawiacie się Czy cztery proste zasady mogą doprowadzić do takiego stopnia złożoności.
...
Ale jeśli przestrzegamy zasad origami, możemy tych wzorców użyć w innej konstrukcji, która sama mogła być czymś bardzo prostym, ale gdy je połączymy, dostajemy coś trochę innego.
Ta ryba ma 400 łusek została wykonana z jednego arkusza, bez nacinania, tylko składając.
Jeśli nie chcesz składać 400 łusek, możesz się wycofać i zrobić tylko kilka elementów, na przykład dodać tarczki na skorupie żółwia, lub palce.
Albo możesz podjąć wyzwanie i zrobić 50 gwiazdek i 13 pasków na fladze.
A jeśli chcesz zaszaleć 1 000 łusek grzechotnika.
Ten egzemplarz jest na wystawie na dole, więc zerknijcie na niego przy okazji.
...
Czy można tak szczegółowo go odtworzyć.
Tak, naprawdę można.
Jak się to robi .
Trzeba to sobie podzielić na kilka mniejszych kroków.
Rozbuduję trochę moje równanie.
Zaczynam od pomysłu .
Jaka jest najbardziej abstrakcyjna forma .
To kreska.
I zaczynając od figury z kresek muszę jakoś dojść do złożonego kształtu, który ma elementy odpowiadające częściom oryginalnego obiektu Wypustkę na każdą nogę.
I kiedy złożyłem już kształt nazywany bazą, można nogi zwęzić, zgiąć, doprowadzić do ostatecznego kształtu.
Pierwszy krok całkiem łatwy.
Weź pomysł, narysuj kreskową figurę.
Ostatni krok też nie jest trudny, ale ten środkowy przejście od abstrakcyjnego opisu do złożonego kształtu jest trudne.
To wtedy pojęcia matematyczne pomagają nam uporać się z problemem.
...
Weź kwadrat .
Złóż go na pół, znowu na pół, jeszcze raz, aż stanie się długi i wąski, i można powiedzieć, że na końcu jest wypustka.
...
Jeśli zrobię wypustkę tak wąską, jak to możliwe osiągnę minimum potrzebnego na to papieru.
...
I teraz zaczynają nam pomagać zmarli Wielu ludzi badało problem pakowania kół.
Mogę odnosić się do długiej historii matematyków i artystów pracujących nad pakowaniem kół w różnych układach.
Mogę użyć tych układów do tworzenia wzorów origami.
Skoro już rozgryźliśmy zasady pakowania kół, zaznaczamy wzory kół liniami według kolejnych zasad .
To daje nam zagięcia.
Te zagięcia tworzą bazę .
Kształtujemy tę bazę.
...
Aby użyć komputera, trzeba opisać rzeczy używając bardzo prostych pojęć I to nam się udało.
Napisałem więc kilka lat temu program komputerowy nazywany TreeMaker , można go ściągnąć z mojej strony.
Jest darmowy .
Działa pod większymi systemami operacyjnymi nawet pod Windows.
...
Jeśli na podstawie tej siatki, pozginasz wzdłuż przerywanych linii dostajesz bazę, którą możesz potem formować w jelenia, o dokładnie takiej siatce zagięć, jaką chcesz.
Jeśli chcesz innego jelenia, nie wirginijskiego, możesz zmienić upakowanie, i zrobić wapiti.
Albo łosia.
...
A jeśli złożenie jednej modliszki z jednego arkusza bez nacinania nie było dość ciekawe, można zrobić dwie modliszki z jednego arkusza, bez przecinania.
Ona go pożera.
Nazwałem to Przekąska .
Można zrobić nie tylko owady.
Można dodawać szczegóły palce i pazury .
Niedźwiedź grizzly ma pazury.
Ta żabka drzewna ma palce.
Wielu origamistów dodaje teraz palce do swoich modeli.
Palce stały się memem w origami Wszyscy je robią.
Można robić zestawy figur.
To kilku muzyków.
Gitarzysta z jednego arkusza, kontrabasista z jednego arkusza.
...
To nam umożliwiło tworzenie origami na żądanie.
...
Wszystko, co tu zobaczycie, oprócz samochodu, to origami.
To był naprawdę tylko poskładany papier.
Komputerom zawdzięczamy efekt ruchu, ale to były wszystko prawdziwe składane figurki.
Można tego użyć nie tylko do tworzenia filmów, ale okazuje się być przydatne w praktyce.
...
Oto jeden z najwcześniejszych zastosowanych składanych wzorców badany przez Koryo Miura ę, japońskiego inżyniera.
Badał wzór składania i odkrył, że można z niego zrobić bardzo kompaktową bryłę, o bardzo prostej otwierającej i zamykającej się strukturze.
I użył jej do zaprojektowania tych paneli słonecznych.
Choć jest to artystyczna interpretacja, ale poleciało jako część japońskiego teleskopu w 1995.
Właściwie w kosmicznym teleskopie Jamesa Webba jest tylko trochę prostego origami.
Teleskop wznosząc się w przestrzeń kosmiczną rozkłada się w dwóch miejscach.
A składa w trzech .
To bardzo prosty wzór trudno to nawet nazwać origami.
Na pewno nie trzeba do tego artystów origami.
Ale jeśli chcemy lecieć wyżej i dalej, trochę origami już się przyda.
Inżynierowie z Narodowego Laboratorium im Lawrence a Livermore a mieli pomysł, by zrobić dużo większy teleskop.
Nazwali go Monoklem .
...
Były dwie grupy ludzi zainteresowanych tym projektem badacze planet, którzy chcą patrzeć w górę i inni ludzie, którzy chcą patrzeć w dół.
Niezależnie od tego, czy chcesz patrzeć w górę, czy w dół, jak wynieść takie coś w kosmos .
Trzeba wysłać to rakietą.
A rakiety są małe .
Więc trzeba to zmniejszyć.
...
Inżynierowie Livermore poprosili, byśmy użyli rozwiązań nieżyjących ludzi, albo ewentualnie żyjących origamistów, Sprawdźmy, czy ktoś jeszcze robi coś takiego.
Rozglądali się więc w środowisku origamistów, skontaktowaliśmy się i zacząłem z nimi pracować.
Opracowaliśmy razem wzorzec który można skalować do dowolnego rozmiaru i który pozwala na złożenie płaskiego pierścienia lub dysku w bardzo mały, kompaktowy cylinder.
Użyli tego w soczewce pierwszej generacji, która nie miała jeszcze 100 metrów, tylko pięć.
Ale ten pięciometrowy teleskop ma ogniskową długości niemal 400 m.
Działa doskonale w warunkach testowych i ładnie się składa w nieduży pakunek.
To jest origami w kosmosie.
Japońska Agencja Badań Kosmicznych wystrzeliła żagiel słoneczny i jak tutaj widać, żagiel się rozkłada, ale można wciąż dostrzec linie zagięć.
Rozwiązano tutaj problem polegający na tym, że coś co musi być wielką płachtą w miejscu docelowym, musi być znacznie mniejsze w trakcie podróży.
To działa zarówno w podróżach w kosmos, jak i w podróży w głąb ciała.
Tu mamy ten drugi przykład.
To jest stent kardiologiczny opracowany przez Zhong You na Uniwersytecie w Oxfordzie.
...
Ten stent składa się według wzoru origami opartego na modelu zwanego bombą wodną.
...
Algorytmy, które opracowaliśmy by robić owady okazały się być rozwiązaniem problemu symulacji poduszek powietrznych.
Taka symulacja jest teraz możliwa.
Tutaj tworzy się siatka zagięć, a tu widać, jak poduszka napełnia się powietrzem i jak to rozwiązanie działa.
...
Algorytm spłaszczania poduszki powietrznej powstał dzięki badaniom nad pakowaniem kół oraz teorii matematycznej, która została opracowana głównie po to, by tworzyć owady rzeczy z nogami.
Rzecz w tym, że to się często zdarza w matematyce i nauce.
Gdy pojawia się matematyka, problemy rozwiązywane ze względów estetycznych lub dla stworzenia czegoś pięknego, okazują się mieć zastosowania w prawdziwym świecie.
Może się to wydać dziwne i zaskakujące, ale origami może kiedyś komuś ocalić życie.
Dziękuję.
...
Nie są to ściśle naukowe rzeczy, Nie są to ściśle naukowe rzeczy, ale rzeczy, które wszyscy znamy.
Rozpocznę od tego Gdy mama jest smutna, wszyscy się smucą.
Znamy to, prawda.
Na tej bazie możemy przejść Na tej bazie możemy przejść do następnego kroku, gdy ocean się smuci, wszyscy się smucą gdy ocean się smuci, wszyscy się smucą.
To temat mojego wykładu.
Zasmucamy ocean na wiele sposobów.
To zdjęcie Cannery Row z 1932 roku.
W tym czasie znajdowała się tam największa fabryka konserw na zachodnim wybrzeżu znajdowała się tam największa fabryka konserw na zachodnim wybrzeżu.
W dużym stopniu zanieczyściliśmy powietrze oraz wodę.
Rolf Bolin, były profesor na Stacji Morskiej Hopkina, gdzie pracuję, napisał w 1940 roku Opary z piany unoszącej się w ujściu zatoki były tak toksyczne, że zamieniały kolor farb ołowianych na czarny Ludzie pracujący w tych fabrykach nie mogli znieść unoszącego się zapachu Wiecie co im mówiono.
Wiecie co to za zapach.
To zapach pieniędzy.
Zanieczyszczenie było dla tych ludzi pieniędzmi Narażali się na nie, wchłaniali je przez skórę, w swoje ciała, ponieważ potrzebowali pieniędzy.
Zasmuciliśmy ocean, więc zasmuciliśmy ludzi i naraziliśmy ich zdrowie.
Link pomiędzy zdrowiem oceanu a ludzkim bazuje na dwóch prostych porzekadłach Chciałbym to zatytułować polując na płotkę ranisz wieloryba.
Piramida życia w oceanie.
Gdy ekolog obserwuje ocean, robi to w zupełnie inny sposób, widzi rzeczy, których nie zauważa zwykła osoba Gdy ekolog obserwuje ocean widzi wiele zależności.
Widzimy podstawę łańcuch pokarmowego, plankton, małe organizmy i widzimy jak te zwierzęta stają się pożywieniem dla innych ze środka piramidy w górę stają się pożywieniem dla innych ze środka piramidy w górę.
Ten przepływ życia od podstawy do samej góry widzą ekolodzy.
Jest to tym, co staramy się chronić mówiąc Ocal ocean .
To ta piramida.
Jaki to ma związek z ludzkim zdrowiem.
Gdy zostawiamy na dnie piramidy rzeczy, których nie powinno tam być Gdy zostawiamy na dnie piramidy rzeczy, których nie powinno tam być dzieją się straszne rzeczy.
Niektóre zanieczyszczenia sami stworzyliśmy, molekuły jak PCB, które nie rozkładają się w naszych organizmach.
Dostają się do podstawy piramidy i przedostają się do organizmów drapieżników i przedostają się do organizmów drapieżników Gdzie się akumulują Gdzie się akumulują.
Wymyśliłem pewną grę ukazującą to.
Nie musimy w nią grać, możemy o niej porozmawiać.
To gra w styropian i czekoladę.
Wyobraźmy sobie, że wsiadając na łódkę każdy dostaje dwie styropianowe kulki każdy dostaje dwie styropianowe kulki.
...
Nie ma sposobu na pozbycie się kulek Nie ma sposobu na pozbycie się kulek więc tworzą coraz większy stos niestrawnych kulek więc tworzą coraz większy stos niestrawnych kulek.
To samo dzieje się z PCB w piramidzie Odkładają się na górze piramidy.
Teraz przypuśćmy, że zamiast styropianu dostajemy smakowite czekoladki dostajemy smakowite czekoladki.
Niektórzy sami zjedliby czekoladki, zamiast przekazywać je dalej Niektórzy sami zjedliby czekoladki, zamiast przekazywać je dalej Ale zamiast odkładania się zostaną w naszej grupie nie akumulując się nigdzie zostaną w naszej grupie nie akumulując się nigdzie Zostaną przez nas wchłonięte.
Taka jest różnica między PCB, a kwasami omega 3, naturalnie występującymi w morskim łańcuchu pokarmowym kwasami omega 3, naturalnie występującymi w morskim łańcuchu pokarmowym.
PCB się odkłada.
...
Delfiny jedzą ryby które pobierają PCB z planktonem, następnie PCB, które rozpuszczają się w tłuszczach, odkładają się w organizmach delfinów Delfin matka lub każdy inny tylko w jeden sposób Delfin matka lub każdy inny tylko w jeden sposób pozbywa się PCB.
Jaki.
Z mlekiem matki.
...
Te samice mimowolnie przekazują PCB pochodzące z mleka swoich matek, swoim młodym, które nie przeżywają .
Procent przypadków śmiertelnych pierwszych młodych Procent przypadków śmiertelnych pierwszych młodych wynosi od 60 do 80.
Matki karmią pierwsze młode zanieczyszczonym mlekie i większość z nich umiera.
Matka może się ponownie rozmnażać, ale jak wysoką cenę płaci, przez akumulację toksyn w swoim organizmie śmierć pierwszego młodego.
Istnieje inny drapieżnik na końcu łańcucha.
Ten drapieżnik to oczywiście my.
My także spożywamy mięso pochodzące z tych miejsc.
To mięso wieloryba, które sfotografowałem sprzedawane w sklepie w Tokyo, na pewno.
Kilka lat temu nauczyliśmy się jak przemycić laboratorium molekularne do Tokyo, aby pobrać próbki DNA z mięsa waleni i sprawdzić czym są naprawdę.
...
To mięso zawierało ogromne ilości PCB, dioksyn i ciężkich metali.
...
To tragedia tego gatunku, a także tragedia ludzi nieświadomie spożywających toksyczne mięso .
Dostarczono nam te dane kilka lat temu.
Pamiętam, jak siedziałem przy biurku ze świadomością, że jestem jedyną osobą, która wie, że mięso sprzedawane jako mięso wielorybów, pochodzi od delfinów i jest toksyczne.
Miało dwa, trzy a nawet 400 razy więcej toksyn, niż ilość dopuszczana przez EPA.
Pamiętam, jak pomyślałem to wyjątkowe, naukowe odkrycie, ale jak okropne.
Po raz pierwszy w swojej karierze złamałem etykietę, która zakłada opublikowanie danych w magazynie naukowym przed rozpoczęciem rozmów.
Wysłaliśmy bardzo uprzejmy list do ministra zdrowia Japonii, podkreślając, że to niedopuszczalna sytuacja, nie tylko dla nas, ale dla obywateli Japonii, ponieważ karmiące matki z dziećmi mogą nieświadomie kupić toksyczne mięso .
To doprowadziło to fali kolejnych kampanii w Japonii .
Muszę z dumą przyznać, że dziś trudno o kupienie w Japonii mięsa źle oznakowanego, trudno o kupienie w Japonii mięsa źle oznakowanego, nawet jeśli nadal sprzedaje się mięso wielorybów.
Jest przynajmniej dobrze oznakowane i kupując je nie ryzykujemy zatruciem .
Nie tylko tam się to zdarza Diety niektórych społeczeństw Arktyki kanadyjskiej, europejskiej i w Stanach Zjednoczonych, diety bazujące na fokach i wielorybach prowadzą do akumulacji PCB pochodzącego z całego świata w organizmach tych kobiet.
Te kobiety mają toksyczne mleko.
Nie mogą karmić własnych potomków, dzieci, własnym mlekiem z powodu akumulacji tych toksyn w ich łańcuchu pokarmowym w tej części świata piramidy oceanu .
Ich system immunologiczny jest osłabiony.
Więc rozwój ich dzieci może być osłabiony .
Zredukowaliśmy problem tych kobiet w ciągu ostatniej dekady, nie zmieniając piramidy, ale zmieniając rzeczy przez nie spożywane.
...
Gdy umieścimy na dnie piramidy środki odżywcze, ścieki, nawozy, powrócą one na innych poziomach.
Tak powstają zjawiska, o których często słyszymy zakwity wody, spowodowane przez kwitnące toksyczne algi zakwity wody, spowodowane przez kwitnące toksyczne algi unoszące się na wodzie, powodujące zmiany neurologiczne .
A także zakwity bakterii, lub wirusów w oceanie.
Te dwa zdjęcia przedstawiają czerwony zakwit na przegu oraz bakterię z rodzaju przecinkowca, tego samego rodzaju co cholera.
Ilu z nas widziało znak plaża zamknięta .
Dlaczego tak się dzieje.
Dzieje się tak, ponieważ zaśmieciliśmy podstawę piramidy tak bardzo, że bakterie zapełniają nasze plaże.
Częstym powodem są ścieki.
A ilu z nas wchodząc do rezerwatu przyrody zauważyło znak Park niezdatny do użycia z powodu zanieczyszczeń ściekowych .
Niezbyt często .
Nie uznalibyśmy tego.
Nie tolerujemy parków zamkniętych przez ludzkie ścieki, ale wiele plaż jest zamykanych.
Na całym świecie zamyka się coraz więcej plaż, z tego samego powodu, i uważam, że tego też nie powinniśmy tolerować.
To nie tylko kwestia czystości, ale kwestia chorób, które te organizmy wywołują.
Przecinkowce, te bakterie są niebezpieczne dla ludzi.
...
Niektóre strony dla surferów zawierają niektóre strony dla surferów zawierają oprócz informacji o falach i pogodzie małe znaczki w kształcie kału .
Oznacza to, że plaża, mimo iż ma wspaniałe fale, jest niebezpieczna, ponieważ po całym dniu pływania, można nabawić się problemu, którego niełatwo się pozbyć.
Niektóre z tych infekcji zawierają geny odporne na antybiotyki, przez co leczy się je jeszcze trudniej.
...
Rita Calwell w ciekawy sposób prześledziła w jaki sposób cholera dostaje się do naszego społeczeństwa przez widłonogi.
Widłonogi to małe skorupiaki.
Mają długość jednego cala i na swoich małych kończynach przenoszą bakterie cholery, prowadzące do zakażenia.
W ten sposób rozprzestrzeniły się epidemie cholery na całym świecie prowadząc do wzmożonej uwagi na nierozprzestrzenianiu się nosicieli cholery na świecie.
Co możemy zrobić.
Stajemy przed głównym problemem piramidy, w której przepływ ekosystemu jest zakłócony od podstawy do samego szczytu.
Co możemy z tym zrobić.
Wiele rzeczy.
Na przykład zadzwonić po hydraulika Joe.
Może przyjechać i naprawić przepływ.
W zasadzie, istnieje wiele miejsc na świecie, gdzie można naprawić problemy oraz gdzie uporano się z tymi problemami, gdzie ludzie zdając sobie sprawę z niebezpieczeństwa, uporali się z nimi .
...
Przemysł zniknął .
Zanieczyszczenie się zmniejszyło.
Ale musimy pamiętać, że społeczeństwa potrzebują działających ekosystemów.
Potrzebują działającej piramidy od podstawy po szczyt.
Piramida w Monterey działa teraz, Piramida w Monterey działa teraz, dzięki wysiłkom wielu ludzi, lepiej niż kiedykolwiek od 150 lat.
To nie przypadek.
...
W 1931 roku stworzyła pierwszy morski rezerwat w Kalifornii znajdujący się obok terenu uprzemysłowionego, ponieważ wiedziała, że kiedy zamkniemy fabryki konserw, będziemy potrzebować miejsca, z którego ocean będzie się rozrastał, chciała zapewnić pierwotne ziarno.
Ta zmiana w myśleniu doprowadziła do wielu zmian nie tylko w Monterey Bay, ale również w innych miejscach na świecie.
Zostawiam Was z myślą, że staramy się chronić piramidę i że piramida życia w oceanie jest połączona z naszą.
Żyjemy na planecie oceanicznej a uważamy się za gatunki naziemne, ale piramida oceanu i nasze życie na lądzie są ściśle połączone.
...
Podam przykład .
Jeśli zabierzesz kraba z plaży, przetransportujesz na drugi kraniec kontynentu i wrzucisz do skośnej klatki, będzie się wspinał po klatce w rytm przypływu z rodzinnych stron, a podczas odpływu będzie schodził, tysiące mil od domu.
...
Można znaleźć ochotników, który wychodząc często przechwalają się, jak produktywnie spędzili czas.
Chociaż to dziwacy, wszyscy pokazują jedno.
Co dzień wstają jakieś 15 minut później i dryfują tak przez całą dobę na przestrzeni tygodni.
Dzięki temu wiemy, że polegają na wewnętrznym zegarze, zamiast wyczuwać czas zewnętrzny.
Mamy zegar biologiczny, jak się okazuje, bardzo dla nas ważny.
...
Nasze nowoczesne metody mają swoje zalety, ale powinniśmy zrozumieć ich koszty.
Dziękuję.
...
Haa haa haaa.
Oddech jest dla nas naprawdę ważny.
To ruch, który jest dosyć niezwykły jak na lalki, więc każdą lalkę teatralną staramy się wzbogacić o taką możliwość.
To jest to, co odróżnia lalkę AK Ups.
Od aktora.
...
Tak, to w zasadzie martwy przedmiot, jak sami widzicie i żyje wyłącznie dlatego, że ty czynisz ją żywą.
...
Tak więc za każdym razem, gdy wychodzi na scenę, musi o to walczyć.
Nazywamy to więc przykładem inżynierii emocjonalnej, który wykorzystuje najnowocześniejszą aby zmienić RZECZowniki w czasowniki strony czynnej.
Cóż, ja powiedziałbym raczej, że to jest przedmiot skonstruowany z drewna i materiału, wzbogacony o możliwość ruchu, po to, aby przekonać cię, że tętni w nim życie.
A więc w porządku.
Ma uszy, które biernie się poruszają, gdy porusza się głowa.
...
W Port Elizabeth, wiosce nieopodal Port Elizabeth w południowej Afryce.
Jego matka była lalkarką.
I kiedy spotkaliśmy się w szkole artystycznej i zakochaliśmy się w sobie w 1971, Nienawidziłem lalek teatralnych.
...
W rzeczy samej, aż 10 lat potrzebowałem, aby odkryć lalki Bamaro bambano z Mali we wschodniej Afryce, gdzie mają wspaniałą tradycję wykonywania lalek i odzyskać lub zyskać szacunek dla tej formy sztuki.
Tak więc w 1981 roku przekonałem Basil a i kilku moich przyjaciół do stworzenia firmy lalkarskiej.
...
Osoba w miejscu tylnych nóg porusza także ogonem, to trochę jak w przypadku hieny to ten sam mechanizm, tylko trochę większy.
Kontroluje także ruchy uszu.
Tak więc to dzieło widział Tom Morris z Teatru Narodowego w Londynie.
I mniej więcej w tym samym czasie jego matka powiedziała Czy widziałeś tą książkę Michael a Morpurgo pod tytułem Koń Wojenny .
Opowiada o chłopcu, który pokochał pewnego konia.
Koń został później sprzedany na potrzeby pierwszej wojny światowej, a on zaciąga się do wojska, by znaleźć tego konia.
Tak więc Tom zadzwonił do nas i zapytał Czy sądzicie, że bylibyście w stanie wykonać konia na potrzeby przedstawienia w Teatrze Narodowym.
Wydawało się to urzekającym pomysłem.
Musiał jednak dać się ujeździć Musiał mieć jeźdźca.
Musiał mieć jeźdźca i musiał uczestniczyć w szarżach kawalerii.
Przedstawienie o dwudziestowiecznej technologii orania i szarżach kawalerii stanowiła nie lada wyzwanie dla działu księgowości Teatru Narodowego w Londynie.
Ale zgodzili się dać temu szansę na okres próbny.
Zaczęliśmy więc od testu.
To jest Adrian i Thys Stander, którzy zabrali się potem za projektowanie struktury z trzciny dla tego konia i nasza, mieszkająca tuż obok, sąsiadka Katherine, jadąca na drabinie.
Waga stanowi wielki problem, jeśli masz ją nad swoją głową.
A kiedy już kazaliśmy Katherine przejść przez ten szczególny rodzaj piekła, wiedzieliśmy, że może nam się udać stworzenie konia, którego będzie można ujeżdżać.
...
W środku widać dwie osoby obsługujące mechanizmy.
Wtedy jednak nie wiedzieliśmy, że będziemy potrzebować trzeciej osoby do obsługi mechanizmów, ponieważ nie byliśmy w stanie poruszać szyją od środka, jednocześnie sprawiając by koń chodził.
Rozpoczęliśmy prace nad prototypem po tym, jak model został zaakceptowany, ale praca nad prototypem zajęła trochę dłużej, niż przewidywaliśmy.
...
Więc wzięliśmy aparat i ułożyliśmy lalkę w różnych pozycjach przypominających galop.
Potem wysłaliśmy to do Teatru Narodowego w nadziei, że uwierzą, że stworzyliśmy coś, co w ogóle działało.
Miesiąc później byliśmy już w Londynie Mieliśmy wielkie pudło i studio pełne ludzi, którzy mieli z nami współpracować.
Było tam około 40 ludzi.
Byliśmy przerażeni.
...
Ale ponieważ muszą być lekkie i elastyczne, a każdy z nich jest inny, nie możemy ich produkować masowo, niestety.
...
Joey, Joey, Joey, Joey.
Podejdź tutaj .
Stań tak, aby ludzie mogli cię zobaczyć.
No, chodź.
Chciałbym tylko opisać Nie będę mówił zbyt głośno .
...
Kontroluje on głowę także bezpośrednio używając swojej dłoni.
...
A tutaj Tommy zajmuje tak zwaną pozycję sercową.
Obsługuje nogę.
...
Sposób, w jaki podnosi się kopyto u konia natychmiast sprawia, że masz wrażenie, że koń porusza się, jak prawdziwy.
Tylne nogi zdolne są wykonywać taką samą czynność.
Mikey ma też coś, co pozwala mu palcami poruszać ogonem konia z lewa na prawo i z góry na dół, jeśli będzie używał drugiej dłoni.
Razem daje to mu całkiem szeroki wachlarz możliwości poruszania ogonem.
Chcesz coś powiedzieć o oddychaniu.
Oddychanie stanowiło dla nas wielkie wyzwanie.
Adrian myślał, że będzie musiał rozdzielić klatkę piersiową lalki na pół, aby sprawić, by oddychała w taki sposób ponieważ w taki sposób oddychałby żywy koń, z rozszerzoną klatką piersiową.
Uświadomiliśmy sobie jednak, że jeśli tak byśmy to rozwiązali, to wy, jako publiczność, nie moglibyście zobaczyć, jak oddycha.
...
Jeśli chodzi o inne sprawy związane z emocjami .
...
Chciałbym, abyście myśleli, że wybór padł na trzcinę ze względów estetycznych, że wykonałem trójwymiarowy rysunek konia, który w pewien sposób porusza się w przestrzeni.
Powód był jednak taki, że trzcina jest lekka, jest elastyczna, jest wytrzymała i można jej nadawać dowolny kształt.
Tak więc był praktyczny powód, dla którego zostało to wykonane z trzciny.
Sama skóra jest wykonana z przezroczystej siatki nylonowej, a jeśli specjalista od oświetlenia chce, aby koń niemal zniknął, może oświetlić tło i wtedy koń stanie się przezroczysty jak duch.
...
I niech stanie dęba.
Dziękuję.
A teraz, żeby tylko aż ze słonecznej Kalifornii przyjechała do nas Zem Joaquin, która zademonstruje nam jazdę na koniu.
...
Nie są oni w stanie ze sobą rozmawiać, gdy są na scenie, ponieważ wszyscy mają przy sobie mikrofony.
Odgłos, jaki wydaje bardzo wielka klatka piersiowa konia wydaje rżenie i ciche rżenie, słowem wszystko zaczyna jeden wykonawca, kontynuuje to druga osoba, a kończy to trzecia.
Mikey Brett z Leicestershire.
Mikey Brett, Craig, Leo, Zem Joaquin, Basil i ja.
Dziękuję Dziękuję.
...
Dlatego zapragnąłem zrozumieć, co sprawia, że warto żyć.
...
Przebywałem wtedy w kurorcie narciarskim w Szwajcarii, bez grosza i szansy na jakąkolwiek rozrywkę Śnieg stopniał, nie miałem pieniędzy na kino, jednak przeczytałem w gazecie, że szykował się jakiś wykład gdzieś chyba w centrum Zurychu Ktoś miał mówić o latających talerzach.
...
Zamiast opowiadać o małych zielonych istotach, mówił o tym, jak psychika Europejczyków została zniszczona traumą wojny i jak teraz twierdzą, że widzą na niebie latające talerze.
...
Oto typowe wyniki, przedstawiane wielokrotnie w różnych wersjach.
...
W tym samym czasie dochód, przedstawiony w stałej skali uwzględniającej inflację, wzrósł w tym czasie ponad dwukrotnie, prawie potroił się.
Jednak wyniki właściwie się nie zmieniły, czyli po pewnym punkcie podstawowym, który odpowiada mniej więcej zaledwie kilku tysiącom dolarów powyżej dolnej granicy ubóstwa, poprawa sytuacji materialnej nie ma wpływu na poczucie szczęścia.
...
Jakby się nad tym zastanowić, to ciekawe, że gdy myślimy o cywilizacjach postrzeganych jako twórców największych osiągnięć ludzkości, czy to będą Chiny, Grecja czy Indie, Majowie czy Egipcjanie, to co o nich wiemy dotyczy tak naprawdę ich ekstaz, a nie codziennego życia.
Znamy ich świątynie, czyli miejsca, gdzie ludzie przychodzili, aby doświadczyć innej rzeczywistości.
Wiemy o cyrkach, arenach, teatrach .
...
Wystarcza mu kartka papieru, na której może umieszczać małe znaczki i gdy to robi, potrafi wyobrażać sobie dźwięki, które nie istniały wcześniej w tej wyjątkowej konfiguracji.
Kiedy zaczyna tworzyć, podobnie jak Jennifer podczas improwizacji, nową rzeczywistość, to jest to chwila ekstazy Wkracza w inną rzeczywistość.
Mówi, że jest to doświadczenie tak intensywne, jakby on sam przestawał istnieć.
Brzmi to jak jakaś romantyczna przesada,.
Jednak w rzeczywistości nasz system nerwowy nie jest w stanie przetwarzać więcej niż 110 bitów informacji na sekundę.
...
Prawdziwe zaangażowanie w ten całkowicie pochłaniający proces tworzenia czegoś nowego jak u tego kompozytora nie pozostawia mu dość dużo uwagi, żeby monitorować, co czuje jego ciało, czy myśleć o problemach w domu.
...
Czy będzie to matematyka czy muzyka potrzeba tak długiego czasu, aby być w stanie zmienić coś tak, by stało się lepsze niż wcześniej.
Kiedy do tego dochodzi, jak mówi, muzyka płynie sama.
...
Zapisał to jeden z moich studentów, który przeprowadził wywiady z kilkoma wiodącymi pisarzami i poetami w Stanach.
...
Moja kolejna studentka, Susan Jackson z Australii, pracowała z kilkoma najlepszymi sportowcami na świecie.
W wyświetlonym opisie pewnego łyżwiarza widzimy zasadniczo ten sam opis fenomenologii wewnętrznego stanu osoby.
Nie myślisz, rzeczy dzieją się automatycznie, stajesz się jednym z muzyką, i tym podobne.
Zdarza się to także innym W mojej najnowszej książce, zatytułowanej Good Business , zamieściłem wywiady z dyrektorami generalnymi, wskazanymi przez swoich współpracowników, jako łączący sukces zawodowy z bardzo etycznym i odpowiedzialnym postępowaniem.
Owi dyrektorzy zdefiniowali sukces, jako coś, co pomaga innym i jednocześnie daje ci uczucie szczęścia, gdy nad tym pracujesz.
Każdy z tych utalentowanych i odpowiedzialnych dyrektorów podkreślał, że tylko jedna tych rzeczy to za mało, aby odnieść sukces i mieć pracę, w której można się spełnić.
...
To rodzaj pasji, która wypływa z robienia czegoś najlepszego i doświadczania uskrzydlenia podczas pracy.
A to interesujący, krótki cytat z Masaru Ibuki, który w tamtym czasie rozkręcał firmę Sony bez pieniędzy, bez produktu nie mieli pomysłu na produkt, nie mieli niczego, oprócz jednej idei.
...
Nie mógłbym dodać nic więcej do tego doskonałego przykładu, jak wprowadzić stan przepływu do miejsca pracy.
Podczas naszych badań wraz z innymi psychologami z całego świata przeprowadziliśmy ponad 8000 wywiadów z różnymi ludźmi od braci dominikanów i niewidomych zakonnic, przez wspinaczy w Himalajach do pasterzy Nawaho którzy lubili swoją pracę.
Niezależnie od kultury, niezależnie od wykształcenia czy czegokolwiek innego, jest siedem oznak występujących, gdy osoba znajduje się w stanie przepływu.
...
Okazuje się, że możemy to zmierzyć bardzo dokładnie, ponieważ rozdajemy pagery, na które wysyłamy wiadomości 10 razy dziennie, i za każdym razem osoba mówi, co robi, jak się czuje, gdzie jest i o czym myśli.
My zaś mierzymy dwie rzeczy poziom trudności doświadczany w tym momencie oraz ocenę własnego poziomu umiejętności w danej chwili.
...
Poznanie tego punktu pozwala dość skutecznie przewidzieć, kiedy nastąpi przepływ, a będzie to, gdy trudności będą większe niż średnie i umiejętności będą większe niż średnie.
Różne osoby mogą wykonywać bardzo różne rzeczy, jednak dla wszystkich kanał przepływu, o tutaj, powstanie podczas robienia czegoś, co się naprawdę lubi gry na pianinie, rozmowy z najlepszym przyjacielem, może podczas pracy, jeśli praca zapewnia ci wejście w stan przepływu.
Pozostałe obszary stają się coraz mniej pozytywne.
Pobudzenie jest dobre, bo gdy poziom trudności jest znacznie podwyższony,.
A umiejętności nie są wystarczająco duże, można w miarę łatwo przejść do stanu przepływu zwiększając odrobinę swoje umiejętności.
...
Pozostałe konfiguracje trudności i umiejętności stają się stopniowo coraz mniej optymalne.
...
Oczywiście, niektórzy z was wiedzą spontanicznie jak to robić, bez żadnej pomocy, jednak niestety wielu ludzi nie wie.
...
Kiedy sto lat temu ponownie odkryto filantropię, kiedy tak naprawdę stworzono jej podstawy, tamci także nie sądzili, że są ze złej strony.
W gruncie rzeczy nigdy nie pomyśleliby o sobie, że są zamknięci i skostniali w swych przyzwyczajeniach, że wolno reagują na nowo wyzwania, albo że są mali i boją się ryzyka.
Wcale tacy nie byli Wtedy na nowo tworzyli filantropię, to co Rockefeller nazywał biznesem życzliwości.
Pod koniec dwudziestego wieku nowe pokolenie krytyków i reformatorów właśnie tak postrzegało filantropię.
Coś czego możemy oczekiwać, wraz z tworzeniem się branży filantropii globalnej, a właśnie dokładnie to dzieje się obecnie, to dążenie do odrzucenia tych starych założeń, po to by filantropia mogła stać się otwarta i wielka, szybka, łącząca i długotrwała.
Ten przedsiębiorczy zapał wyłania się z wielu stron.
Jest napędzany przez nowych przywódców, takich jak wiele osób tutaj, przez nowe narzędzia, takie jak te, które widzieliśmy tutaj, przez nowe naciski.
Śledzę i uczestniczę w tej zmianie już od dłuższego czasu.
Ten raport to nasz główny raport publiczny.
Opowiada historię tego, jak dzień dzisiejszy może być chwilą równie historyczną jak te sprzed 100 lat.
Chcę podzielić się z wami najciekawszymi rzeczami, które się obecnie dzieją.
Robiąc to, nie będę się zbytnio rozwodzić na temat filantropii na dużą skalę, o której wszyscy już wszystko wiedzą, typu Gates, Soros czy Google.
Zamiast tego chcę mówić o filantropii w nas wszystkich O demokratyzacji filantropii.
To jest moment w historii, kiedy przeciętna osoba ma więcej władzy niż kiedykolwiek indziej.
Przyjrzę się teraz pięciu kategoriom eksperymentów, z których każdy kwestionuje dawne założenia filantropii.
...
Clay Shirky, wspaniały kronikarz wszystkiego co połączone w sieć, podsumował tę kwestionowaną tezę w taki piękny sposób.
...
Wypatrujcie wiosną nowej książki Paula Hawken a, autora i przedsiębiorce, o którym może słyszeliście.
...
WISER oznacza Światowy Indeks Odpowiedzialności Społecznej i Środowiskowej.
WISER zamierza udokumentować, połączyć i dać władzę czemuś, co Paul nazywa największym ruchem i najszybciej rosnącym ruchem w historii człowieka Zbiorowa reakcja immunologiczna ludzkości na zagrożenia dnia dzisiejszego.
Z tych wielkich rzeczy robionych z miłości, eksperymentów, nie wszystkie się powiodą.
Te zrealizowane będą największą, najbardziej otwartą, najszybszą, najlepiej powiązaną formą filantropii w historii człowieka.
...
To kwestionuje jeszcze inne założenie, że filantropia zorganizowana jest tylko dla bardzo zamożnych.
Spójrzcie, jeśli jeszcze tego nie zrobiliście, na DonorsChoose .
...
Spójrzcie na organizację Changing the Present założoną przez TEDznajomego, kiedy będziecie potrzebować prezentu ślubnego, czy świątecznego.
...
Chodzi o to, że sprzeciwił się kolejnej tezie, że każdy dawca musi mieć swój fundusz lub fundację.
Obecnie jest wiele nowych funduszy, które łączą dawanie i inwestowanie, skupiając ludzi wokół wspólnego celu, żeby myśleli na wielką skalę.
Jeden z najlepiej znanych to Acumen Fund , prowadzony przez Jacqeline Novogratz, TEDznajomą, której TED dodał skrzydeł.
Ale jest wiele innych New Profit w Cambridge, New Schools Venture Fund w Dolinie Krzemowej, Venture Philanthropy Partners w Waszyngtonie, Global Fund for Women w San Francisco.
Popatrzcie na nie.
Te fundusze są dla filantropii tym czym kapitał spekulacyjny, prywatne inwestycje kapitałowe i fundusze powiernicze są dla inwestowania Ale z zaskakującą różnicą, ponieważ często wokół tych funduszy tworzy się społeczność, tak jak w przypadku Acumen i innych miejsc.
Teraz wyobraźcie sobie przez chwilę, te trzy pierwsze typy eksperymentów, masową współpracę, internetowy rynek filantropii, dawanie połączone,.
I zobaczcie jak pomagają nam one na nowo odkryć czym jest zorganizowana filantropia.
Niekoniecznie chodzi o fundacje chodzi o nas.
Wyobraźcie sobie mieszankę, że tak to nazwę, tego wszystkiego w przyszłości, kiedy wszystko razem zejdzie się w eksperymentach przyszłości wyobraźcie sobie, że ktoś wyłoży powiedzmy 100 milionów dolarów na inspirujący cel w zeszłym roku w USA odnotowano 21 przypadków darowizn w wysokości 100 milionów dolarów i więcej, więc nie jest to nierealne, ale wyłoży tylko wtedy, gdy zrównoważą to miliony małych darów z całego świata Tym samym angażując mnóstwo ludzi, robiąc reklamę i angażując ludzi w określone działanie.
Szybko przyjrzę się teraz kategoriom czwartej i piątej, którymi są innowacja, rywalizacja i inwestowanie odpowiedzialne społecznie.
...
Te kategorie rozprawiają się z jeszcze jednym założeniem, że dawca i organizacja są w centrum, w przeciwieństwie do stawiania problemu w centrum.
Możecie zwrócić się do tych innowatorów, żeby nam pomogli, zwłaszcza w kwestiach wymagających rozwiązania technologicznego lub naukowego.
To pozostawia ostatnią kategorię, inwestowanie odpowiedzialne społecznie, która faktycznie jest i tak największą z nich wszystkich Tu reprezentuje ją Xiginet.
A to oczywiście rozprawia się z największym z tych założeń, że biznes to biznes, a filantropia to narzędzie ludzi, którzy chcą stworzyć zmiany w świecie.
Xigi jest nową stroną społecznościową zbudowaną przez społeczność, łączącą i odwzorowującą ten nowy rynek kapitału społecznego.
...
To co tu jest naprawdę interesujące to, że nie wymyślamy swojego sposobu na nowy sposób działania Działając w nowy sposób dochodzimy do nowego sposobu myślenia.
Filantropia reorganizuje się na naszych oczach.
Chociaż wszystkie te eksperymenty i wszyscy ci wielcy ofiarodawcy nie wypełniają jeszcze tych aspiracji, sądzę, że to nowy duch czasu otwarty, na dużą skalę, szybki, połączony Miejmy również nadzieję, długotrwały.
...
Jestem dobrej myśli, ponieważ to nie tylko filantropia się reorganizuje Także całe obszary sektora społecznego i biznesowego, zajęte są kwestionowaniem zasady dzień jak co dzień.
A gdziekolwiek nie pojadę, włączając w to TED, czuję, że pojawił się nowy głód moralny, który wciąż rośnie.
Widzimy, że ludzie naprawdę zmagają się, żeby opisać te nowe zjawiska, które mają miejsce.
...
Może tej społecznej osobliwości przed nami boimy się najbardziej Zbieg katastrof, degradacji środowiska, broni masowego rażenia, pandemii, nędzy.
...
I chcę, żebyście sobie wyobrazili, że jesteście na tym zdjęciu.
Chcę, żebyście pomyśleli o społeczności, którą w części chcecie współtworzyć.
Cokolwiek to dla was oznacza.
I chcę, żebyście sobie wyobrazili, dzień za 100 lat, kiedy to wasz wnuk, prawnuk, siostrzenica, bratanek, czy chrześniak, patrzy na to wasze zdjęcie.
Jaką opowieść chcielibyście wtedy o sobie usłyszeć.
Dziękuję bardzo.
Hanna Rosin Świeże doniesienia o rosnącej pozycji kobiet.
Przechodzimy teraz przez niezwykły i bezprecedensowy okres, w którym dynamika władzy między mężczyznami a kobietami gwałtownie się zmienia W wielu miejscach, gdzie ma to największe znaczenie, kobiety przejmują całkowitą kontrolę.
Moja matka nie poszła na studia, w jej czasach.
Niewiele kobiet szło.
Dzisiaj, na każdych dwóch mężczyzn, którzy kończą studia, przypadają trzy kobiety.
...
Ponad 50 procent kadry kierowniczej to dzisiaj kobiety A wśród 15 zawodów, prognozowanych jako najbardziej rozwijające się w następnej dekadzie, tylko dwa nie są zdominowane przez kobiety.
A zatem globalna ekonomia staje się polem, na którym kobiety odnoszą więcej sukcesów niż mężczyźni, wierzcie albo nie, i te zmiany w naszej ekonomii zaczynają gwałtownie wpływać na naszą kulturę na to jak przedstawiane są komedie romantyczne, na kształt naszych związków małżeńskich, na to jak wygląda nasze życie towarzyskie, czy nasz nowy zestaw superbohaterów.
...
Panowie, to nie jest moment, w którym się wyłączacie czy zaczynacie rzucać pomidorami, bo rzecz w tym, że to dotyczy wszystkich nas.
...
Jak wszyscy czytałam wtedy nagłówki na temat recesji i zaczęłam dostrzegać wyraźną tendencję że recesja wpływała na mężczyzn dużo bardziej niż na kobiety.
Przypomniałam sobie wtedy czytaną 10 lat temu książkę autorstwa Susan Faludi, pod tytułem Wystawieni Zdrada Amerykańskiego Mężczyzny w której opisywała, jak mocno recesja uderzyła w mężczyzn Zaczęłam wtedy myśleć, czy aby przy okazji tej recesji nie było jeszcze gorzej.
...
Po drugie, nie chodziło tylko o kryzys mężczyzn, ale również o to, co działo się z kobietami.
...
Powiększyli zatem zakres zbierania danych i w efekcie otrzymali szokujący wynik, mianowicie, że w 1 997 spośród 2 000 społeczności kobiety, młode kobiety, zarabiały więcej niż młodzi mężczyźni.
Tak więc mamy teraz pokolenie młodych kobiet które dorastają ze świadomością, że mają większe możliwości zarobkowe niż otaczający je młodzi mężczyźni.
...
Ale ten proces wpływa na mężczyzn znacznie inaczej niż na kobiety.
...
O co zatem chodzi.
Wygląda, jakby kobiety dostały doładowanie mocy w grze wideo, albo jakby do tabletek antykoncepcyjnych dosypywano jakiegoś tajemnego składnika, dzięki którego wybijają się tak wysoko.
...
Te dwa rodzaje ekonomii wymagają odmiennych zdolności Przypadkowo kobietom znacznie lepiej wyszło nabywanie nowych umiejętności niż mężczyznom.
Kiedyś wystarczyło być facetem po liceum, bez wyższego wykształcenia, ale z określonymi umiejętnościami, by z pomocą związków zawodowych zapewnić sobie życie na całkiem porządnym poziomie klasy średniej.
...
Dzisiejsza gospodarka wymaga całego wachlarza innych cech.
Potrzebna jest inteligencja, zdolność do skupienia uwagi, do otwartej komunikacji i słuchania innych, a także do funkcjonowania w miejscu pracy znacznie bardziej zmiennym niż kiedyś Kobiety radzą sobie z tymi rzeczami wyjątkowo dobrze, jak widać.
...
Według współczesnych książek o zarządzaniu, lider to ktoś, kto wspiera kreatywność, kto potrafi skłonić jego skłonić pracowników widzicie, wciąż mówię jego  kto potrafi skłonić pracowników do dialogu, kto potrafi budować zespół i wspomagać proces twórczy.
...
Któregoś dnia być może matki będą zatrudniać bezrobotnego byłego hutnika w średnim wieku, by opiekował się ich dziećmi, co byłoby dobre dla mężczyzn, ale jeszcze nie nadeszło.
By zobaczyć, co nadejdzie, nie wystarczy obserwacja dzisiejszych pracowników, trzeba zwrócić się ku przyszłym pracownikom.
Tutaj sprawa jest dość prosta.
Poziom wykształcenia kobiet rośnie szybciej niż mężczyzn.
...
Jeszcze bardziej niepokoi to, co dzieje się z młodszymi chłopcami.
Już od około dekady trwają badania nad tak zwanym kryzysem chłopięcym.
Kryzys chłopięcy polega na tym, że bardzo mali chłopcy, z jakiegoś powodu, mają gorsze wyniki w szkole niż małe dziewczynki Istnieją różne teorie na ten temat.
Czy to dlatego, że program nauczania bazuje na zdolnościach werbalnych, bliższych dziewczynkom, a nie chłopcom.
A może za bardzo wymagamy od dzieci spokojnego siedzenia w miejscu, a w efekcie chłopcy mają od początku poczucie porażki.
...
Ale w międzyczasie powołam światową ekspertkę z dziedziny edukacji, którą jest moja 10 letnia córka, Noah, by opowiedziała wam, dlaczego chłopcom w jej klasie idzie gorzej.
Noah Dziewczyny są widocznie mądrzejsze.
...
Noah Dlaczego Po prostu nie uważali na lekcji, kiedy dziewczynki grzecznie siedziały.
HR Sami widzicie.
...
Ale te studentki miały zupełnie inną wizję swej przyszłości.
Powiedziały mi w zasadzie, że będą pracować 18 godzin dziennie, że ich mąż może będzie pracował, ale głównie zajmie się domem i dziećmi.
To mnie naprawdę uderzyło.
A to mój ulubiony cytat z jednej z dziewcząt Mężczyźni to nowa kula u nogi.
Teraz się śmiejecie, ale te słowa mogą też dopiec.
Myślę, że mogą dopiec, ponieważ tysięcy lat nie da się cofnąć bezboleśnie Dlatego mówię, że przechodzimy przez to razem.
Następnego wieczora po rozmowie z tymi studentkami, odwiedziłam też grupę mężczyzn w Kansas Okazali się dokładnie takimi ofiarami gospodarki produkcyjnej, o jakich mówiłam wcześniej.
...
Instruktor stał przed nimi, tłumacząc im, jak stracili tożsamość w nowej sytuacji.
...
Wtedy instruktor napisał na na tablicy 85 000 $ i powiedział To jej dochody Następnie napisał 12 000 $.
To wasze dochody.
...
Na przestrzeni dekad Korea Północna stworzyła jedno z najbardziej patriarchalnych społeczeństw, jakie znamy.
Status kobiet jako obywateli drugiej kategorii został wprost wpisany w kodeks cywilny.
I jeśli kobiecie nie udało się urodzić męskiego potomka, w zasadzie była traktowana na równi ze służącymi.
...
Jak widzicie, te zmiany ekonomiczne mają istotny wpływ na naszą kulturę.
Ponieważ nie przyswoiliśmy jeszcze w pełni tych informacji, to na swój sposób wraca do nas w kulturze popularnej, w tych trochę dziwnych i przerysowanych formach, ilustrujących, jak zmieniają się stereotypy.
Po męskiej stronie pojawia się, jak to zwykł ujmować mój kolega, grupa samców omega , czyli nieudaczników z problemami sercowymi i bez pracy.
Pojawiają się pod różnymi postaciami.
Mamy wiecznego nastolatka.
Mamy pozbawionego wdzięku mizantropa.
Mamy sączącego słabe piwko faceta, który siedzi bezczynnie przed telewizorem i dobrze mu z tym.
...
Natomiast po damskiej stronie przeciwnie, mamy szalone superbohaterki.
Jest Lady Gaga.
...
Bardzo długo w sferze ekonomii posługiwaliśmy się pojęciem szklanego sufitu.
...
Mamy doświadczenie i umiejętności, ale to podstęp, więc jak niby miałybyśmy się przygotować do przebicia się przez ten szklany sufit.
Do tego rozbijanie szklanego sufitu to okropne określenie.
Cóż za szaleniec roztrzaskałby głową szklany sufit.
Obraz, o którym chętnie myślę, zamiast o szklanym suficie, to wysoko zawieszony most.
Wejście na taki most jest bez wątpienia przerażające, ale jednocześnie ekscytujące, bo jest na nim pięknie, można oglądać wspaniały widok.
Świetnie, że tutaj nie ma podstępu, jak przy szklanym suficie.
Nikt, ani kobieta, ani mężczyzna, nie stoi po środku, chcąc przeciąć liny.
...
Nadal pamiętam ten dzień w szkole kiedy nauczycielka powiedziała nam, że światowa populacja osiągnęła trzy miliardy ludzi To było w 1960.
Teraz opowiem, jak zaludnienie zmieniło się od tamtej pory i jak zmieni się w przyszłości Ale nie użyję technologii cyfrowej, jak podczas pierwszych 5 wystąpień.
...
Ale świat się zmienił, za czym nie nadąża zmiana myślenia, taksonomia świata i jego zrozumienie.
...
Zaczną latać.
Kraje o niskich lub średnich dochodach, również pójdą gospodarczo do przodu.
I jeżeli, ale tylko jeżeli, zainwestujemy w odpowiednią zieloną technologię, by uniknąć poważnej zmiany klimatu i żeby energia mogła zostać stosunkowo tania, wówczas oni przemieszczą się aż tu.
